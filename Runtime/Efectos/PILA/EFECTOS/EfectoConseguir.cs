...
namespace Bounds.Duelo.Efectos {
	...
	public class EfectoConseguir : EfectoBase {

		public enum Fuente { MAZO, DESCARTE, MATERIALES }
		private readonly int jugador;
		private readonly int cantidad;
		private readonly List<Fuente> fuentes;
		private readonly Condicion condicion;

		public EfectoConseguir(GameObject fuente, int jugador, int cantidad = 1, List<Fuente> fuentes = null,
				Condicion condicion = null) : base(fuente) {
