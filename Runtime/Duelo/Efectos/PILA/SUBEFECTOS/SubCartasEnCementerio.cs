...
namespace Bounds.Duelo.Pila.Subefectos {
	...
	public class SubCartasEnCementerio : ISubListaDeCartas {

		private readonly int jugador;
		private readonly CondicionCarta condicion;

		public SubCartasEnCementerio(int jugador, CondicionCarta condicion = null) {
		...
		public List<GameObject> Generar() {
			...
			if (jugador == 0 || jugador == 1)
				lista.AddRange(fisica.TraerCartasEnCementerio(1));

			if (jugador == 0 || jugador == 2)
				lista.AddRange(fisica.TraerCartasEnCementerio(2));
