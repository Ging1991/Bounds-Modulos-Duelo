...
namespace Bounds.Duelo.Emblemas {
	...
	public class EmblemaHechizoActivacion {
		...
		public static void ActivarConSacrificio(int jugador, GameObject hechizo, GameObject sacrificio) {
			...
			if (dato.tipo == "SACRIFICIO_MISTICO_NIVEL") {
				CartaInfo sacrificioInfo = sacrificio.GetComponent<CartaInfo>();
				EmblemaEfectos.Activar(new EfectoInvocacionMisticaNivel(hechizo, jugador, sacrificioInfo.original.nivel));
			}
		...
		public static void ActivarConObjetivo(GameObject hechizo, GameObject objetivo) {
			...
			if (dato.tipo == "PARADOJA_OBJETIVO") {
				EmblemaEfectos.Activar(new EfectoSobreCarta(hechizo, new SubParadoja(controlador, info.cartaID), objetivo));
			}
